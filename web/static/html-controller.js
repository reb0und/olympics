...
async function newimg() {
	...
	if (carousel == 0) {
		...
		gameselect.onclick = function () {
			window.location = rootURL + "/badminton.html";
		};
	} else if (carousel == 1) {
		...
		gameselect.onclick = function () {
			window.location = rootURL + "/tennis.html";
		};
	} else if (carousel == 2) {
		...
		gameselect.onclick = function () {
			window.location = rootURL + "/tableTennis.html";
		};
	} else if (carousel == 3) {
		...
		gameselect.onclick = function () {
			window.location = rootURL + "/soccer.html";
		};
	} else if (carousel == 4) {
		...
		gameselect.onclick = function () {
			window.location =
				"https://snap.berkeley.edu/snap/snap.html#present:Username=stevenchenhanwen&ProjectName=boxing%20game";
		};
	}
}
