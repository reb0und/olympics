...
function overlap(object1, object2) {
	...
	let o1corners = [
		[object1.offsetLeft, object1.offsetTop],
		[object1.offsetLeft + object1.offsetWidth, object1.offsetTop],
		[object1.offsetLeft, object1.offsetTop + object1.offsetHeight],
		[
			object1.offsetLeft + object1.offsetWidth,
			object1.offsetTop + object1.offsetHeight,
		],
	];

	let o2 = [
		object2.offsetLeft,
		object2.offsetLeft + object2.offsetWidth,
		object2.offsetTop,
		object2.offsetTop + object2.offsetHeight,
	];
...
function overlap_strict(object1, object2) {
	let o1center = [
		object1.offsetLeft + object1.offsetWidth / 2,
		object1.offsetTop + object1.offsetHeight / 2,
	];

	let o2center = [
		object2.offsetLeft + object2.offsetWidth / 2,
		object2.offsetTop + object2.offsetHeight / 2,
	];

	let dist = Math.sqrt(
		(o1center[0] - o2center[0]) * (o1center[0] - o2center[0]) +
			(o1center[1] - o2center[1]) * (o1center[1] - o2center[1])
	);
...
function render() {
	...
	player.style.top =
		((player1y + zeroize_negative(jumpy)) / 100) * cheight -
	...
	player2.style.top =
		((player2y + zeroize_negative(jumpyother)) / 100) * cheight -
		player.offsetHeight / 2 +
		"px";
